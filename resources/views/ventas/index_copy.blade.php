...
@endif
 @include('ventas.reportes.filtro')
<br>
...
function format ( d ) {
    ...
    html += '<thead><tr><th>&nbsp;</th><th>Articulo</th><th>Cantidad</th><th>Precio</th><th>Total</th><th>Iva</th>';
    html += '</thead>';
    html += '<tbody>';
...
function filtrar(){
        var _newUrl = "{{ route('ventas.data') }}"  + '?desde='+$('#fecha_desde').val()+'&hasta='+$('#fecha_hasta').val()+'&cliente_id='+$('#cliente_id').val()+'&estado='+$('#estado').val();
    ...
    $('#esperando').show()
        if ( $.fn.dataTable.isDataTable( '#tablaListado' ) ) { 
            ...
            "columns": [
                ...
                { "data": "modo", "title":"Modo", "className": 'dt-center' },
                { "data": "estado", "title":"Estado", "className": 'details-control' },
                { "data": "direccion", "title":"Direccion", "className":"dt-right details-control" },
                { "data": "entrega_programada", "title":"Entrega Programada", "className":"dt-right details-control" },
                { "data": "importe", "title":"Importe", "className":"dt-right details-control" },
                { "data": "ciudad", "title":"Ciudad", "className":"dt-right details-control" },
                { "data": "barrio", "title":"Barrio", "className":"dt-right details-control" },
