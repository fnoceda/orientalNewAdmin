...
<head>
    ...
    <title>Shopping Oriental - Contacto</title>
                        ...
                        <div class="col-12">
                            <form method="POST"  action="{{route('contacto')}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="nombre" required type="text" id="nombre" class="form-control" placeholder="Tu nombre" value="{{ old('nombre') }}">
                                </div>
                                <div class="form-group">
                                    <label for="correo">Correo electrónico (*)</label>
                                    <input name="correo" required type="email" id="correo" value="{{ old('correo') }}" class="form-control" placeholder="Tu correo electrónico">
                                </div>
                                <div class="form-group">
                                    <label for="correo">Telefono</label>
                                    <input name="telefono" type="text" id="telefono" value="{{ old('telefono') }}" class="form-control" placeholder="Tu teléfono (opcional)">
                                </div>
                                <div class="form-group">
                                    <label for="mensaje">Mensaje (*)</label>
                                    <textarea required placeholder="Escribe tu mensaje" class="form-control" name="mensaje" id="mensaje" cols="30" rows="5" > {{ old('mensaje') }} </textarea>
                                </div>
                                <div class="form-group">
                                    {!! NoCaptcha::display() !!}
                                </div>
        ...
        <footer class="sticky-footer bg-white">
            <div class="container my-auto">
                <div class="copyright text-center my-auto">
                    Este correo será enviado al área técnica de OrientalPY, por favor escribalo en idioma Español.
                </div>
                <br />
                <div class="copyright text-center my-auto">
